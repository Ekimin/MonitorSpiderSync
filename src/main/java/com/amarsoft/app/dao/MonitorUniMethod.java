...
public class MonitorUniMethod {
    ...
    public List<MonitorModel> getEntMonitorUrl(String bankID,String modelId){
        ...
        ResultSet rs = null;
        String selectSql = "select serinalno,enterprisename,idno,monitorurl,stockblock,inspectlevel,inspectstate from spider_inspect_entity where bankID = ? and  inspectstate = 'Y' and modelId = ?";
